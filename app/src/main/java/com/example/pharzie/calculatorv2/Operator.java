...
public class Operator {
    ...
    public static String calculate(final String str1, final String str2, final String operator) throws Exception {
        ...
        if (!n1.getTag().equals("")) {
            return new Number(-1, n1.getTag()).toString();
        } else if (!n2.getTag().equals("")) {
            return new Number(-1, n2.getTag()).toString();
        }
        switch (operator) {
     ...
     */
    public static String go(final List<String> postExpr) {
